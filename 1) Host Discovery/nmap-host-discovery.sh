...
# COMMON TCP PORT PROBE, IN DISCENDING ORDER OF ACCESSIBILITY:
#
# 80/HTTPS 				COMMON PORT FOR WEB SERVERS
# 25/SMTP				MAIL APPS, FREE FROM FIREWALL
# 22/SSH 				SSH (BETTER THAN TELNET, NO?)
# 443/HTTPS 			SSL TROUGH HTTP TO ENCRYPT DATA
# 21/FTP 				FILE TRANSFER PROTOCOL (OFTEN ALLOWED TROUGH FIREWALL)
# 113/AUTH 				ALLOW SERVERS TO ASK THE USERNAME OF CLIENTS CONNECTED TO THEM.
# 23/TELNET				TELNET IS STILL IN USE
# 53/DOMAIN 			DNS, USEFUL FOR DNS-LOOKUP & CO
# 554/RTSP 				REAL-TIMESTREAM CONTROL PROTOCOL, USED BY MEDIA SERVER WITH QUICKTIME/REALSERVER
# 3389/MS-TERM-SERVER	MICROSOFT TERMINAL SERVICES, ALLOW USERS TO ACCESS DATA/APP ON REMOTE
# 1723/PPTP				POINT-TO-POINT TUNNELING PROTOCOL, OFTEN IMPLEMENTED IN VPN
# 389/LDAP				LIGHTWEIGHT DIRECTORY ACCESS PROTOCOL, USED TO STORE CONTACT DIRECTORY AND OTHER
# 636/LDAPSS			LDAP OVER SSL
# 256/FW1-SECUREMOTE	CHECKPOINT FIREWALL-1 DEVICES
# 
# ADD A HIGH PORT NUMBER, MORE THAN 1024: MANY FIREWALLS
# BLOCK ONLY PRIVILEGES PORTS (FIRST 1024) AND NOT OTHERS.
# USE LIKE "40000" OR "42069" IF U ARE A TRUE L337



# UDP PORT SELECTION
# YOU CAN SEND A PACKET TO THE PORTS THAT IS A COMMON UDP
# AND ANOTHER ONE UNCOMMON E.G. 53 IS UDP AND A RANDOM 37542



# ICMP PROBE SELECTION
# IT IS AT LEAST WORTH TRYING TO DO THE ICMP PROBES